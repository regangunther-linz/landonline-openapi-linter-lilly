...
func TestFetchRules(t *testing.T) {
	t.Run("returns_rules_list_when_success", func(t *testing.T) {
		...
		tests.AssertEquals(t, "https://linz.github.io/landonline-api-restful-guidelines/hyper-media/Hypermedia.html#must-do-not-use-link-headers-with-json-entities", rules.Rules[0].URL)
